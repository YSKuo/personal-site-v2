...
date: 2020-08-20
image: https://miro.medium.com/max/700/0*OugsE36Gqa-MEU_d
...
metatags:
  title: 如何以餐廳為例來了解網路基礎概念
  description: 用一些生活例子來讓大家更了解網路知識。
  og:
    title: 如何以餐廳為例來了解網路基礎概念
    description: 用一些生活例子來讓大家更了解網路知識。
...
來源：[鹿希派被吳宗憲痛罵 卻教起英文：who care要加s](https://www.youtube.com/watch?v=xJR0kLHRR6g)
...
![](https://miro.medium.com/max/698/0*GUXfkCVb8PJW_M-7.JPG)
Google 的 404 頁面
...
有天，但丁在網路上看到有人推薦一家名為 FFFF 的薯條專賣店，所以在便利貼上寫了 FFFF店大薯條一份，貼在房門口之後就倒頭大睡，睡醒來聞到薯條香味就知道但媽已經幫他買好了。
